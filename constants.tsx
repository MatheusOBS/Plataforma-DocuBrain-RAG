...
export const SCHEMA_MODELS: SchemaModel[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        icon: "payments",
        description: "Nível de assinatura do usuário",
      },
      {
        name: "criadoEm",
        type: "DateTime",
        icon: "history",
        description: "Data de registro original",
      },
      {
        name: "documentos",
        type: "Documento[]",
  ...
  },
  {
    ...
    fields: [
      { name: "id", type: "String", isPK: true, icon: "vpn_key" },
      {
        ...
        type: "String",
        icon: "title",
        description: "Título amigável do documento",
      },
      {
        name: "metadados",
        type: "Json",
        icon: "data_object",
        description: "Tags, autor e fonte",
      },
      {
        name: "conteudo",
        type: "String",
        dbType: "@db.Text",
        icon: "notes",
        description: "Corpo do texto original",
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "embedding",
        type: 'Unsupported("vector")',
        dimensions: 1536,
        isVector: true,
        icon: "data_array",
        annotation: '@@index([embedding], ops: "vector_cosine_ops")',
      },
      {
        name: "modelo",
        type: "String",
...
export const METRICS: Metric[] = [
  ...
  },
  {
    ...
    value: "185.000",
    subtitle: "public.Fragmento",
    icon: "segment",
    table: "public.Fragmento",
    trend: "+8%",
  },
  {
    label: "Média Latência",
    value: "42ms",
    subtitle: "Busca Semântica",
    icon: "bolt",
    table: "public.LogBusca",
    trend: "-15%",
    isSpecial: true,
  },
];
...
export const VERSIONS: VersionEntry[] = [
  {
    ...
    author: "MatheusOBS",
    date: "Há 2 horas",
    changes: "Migração para Gemini 1.5 e HNSW Index",
    tag: "Produção",
  },
  {
    id: "v1.1.9",
    author: "MatheusOBS",
    date: "Há 1 dia",
    changes: "Otimização de chunking estratégico",
    tag: "Estável",
  },
  {
    id: "v1.1.8",
    author: "MatheusOBS",
    date: "Há 3 dias",
    changes: "Suporte a metadados dinâmicos (JSONB)",
    tag: "Legado",
  },
];
